...
const QuestionCreateContainer = ({ match }) => {
  ...
  const handleCreateQuestion = () => {
    ...
    dispatch(createQuestion(filteredQuestion))
    .then(data => {
  ...
  return (
    <div style ={{padding: '40px'}}>
      ...
      <QuestionCreate handleCreateQuestion = {handleCreateQuestion} handleQuestionChange = {handleQuestionChange} newQuestion = {newQuestion} title = {'Question Details'} buttonText = 'Create Question' />{" "}
